...
<div class="container">
  <div class="card">
    ...
    <?php $__currentLoopData = $mhs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <input type="text" value=<?php echo e($mhs->nama); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/unibava/resources/views/mahasiswa_edit.blade.php ENDPATH**/ ?>